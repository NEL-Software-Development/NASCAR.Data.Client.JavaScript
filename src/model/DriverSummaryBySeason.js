...
/**
* The DriverSummaryBySeason model module.
* @module model/DriverSummaryBySeason
* @version 1.0
*/
export default class DriverSummaryBySeason {
    /**
    * Constructs a new <code>DriverSummaryBySeason</code>.
    * @alias module:model/DriverSummaryBySeason
    * @class
    */
    ...
    /**
    * Constructs a <code>DriverSummaryBySeason</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DriverSummaryBySeason} obj Optional instance to populate.
    * @return {module:model/DriverSummaryBySeason} The populated <code>DriverSummaryBySeason</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DriverSummaryBySeason();
            ...
            if (data.hasOwnProperty('finish_rank')) {
                obj['finish_rank'] = ApiClient.convertToType(data['finish_rank'], 'Number');
            }
        }
        return obj;
    }
    ...
    * @member {Number} finish_rank
    */
    'finish_rank' = undefined;
