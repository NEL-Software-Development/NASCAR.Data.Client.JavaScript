...
/**
* The DriverSummaryByTrackType model module.
* @module model/DriverSummaryByTrackType
* @version 1.0
*/
export default class DriverSummaryByTrackType {
    /**
    * Constructs a new <code>DriverSummaryByTrackType</code>.
    * @alias module:model/DriverSummaryByTrackType
    * @class
    */
    ...
    /**
    * Constructs a <code>DriverSummaryByTrackType</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DriverSummaryByTrackType} obj Optional instance to populate.
    * @return {module:model/DriverSummaryByTrackType} The populated <code>DriverSummaryByTrackType</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DriverSummaryByTrackType();
