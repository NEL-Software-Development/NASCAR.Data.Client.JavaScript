...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NascarDataClient.DriverSummaryByTrackType();
  });
  ...
  describe('DriverSummaryByTrackType', function() {
    it('should create an instance of DriverSummaryByTrackType', function() {
      // uncomment below and update the code to test DriverSummaryByTrackType
      //var instane = new NascarDataClient.DriverSummaryByTrackType();
      //expect(instance).to.be.a(NascarDataClient.DriverSummaryByTrackType);
    });
