...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NascarDataClient.NextGenSource();
  });
  ...
  describe('NextGenSource', function() {
    it('should create an instance of NextGenSource', function() {
      // uncomment below and update the code to test NextGenSource
      //var instane = new NascarDataClient.NextGenSource();
      //expect(instance).to.be.a(NascarDataClient.NextGenSource);
    });
