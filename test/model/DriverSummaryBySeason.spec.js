...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NascarDataClient.DriverSummaryBySeason();
  });
  ...
  describe('DriverSummaryBySeason', function() {
    it('should create an instance of DriverSummaryBySeason', function() {
      // uncomment below and update the code to test DriverSummaryBySeason
      //var instane = new NascarDataClient.DriverSummaryBySeason();
      //expect(instance).to.be.a(NascarDataClient.DriverSummaryBySeason);
    });
    ...
    it('should have the property finishRank (base name: "finish_rank")', function() {
      // uncomment below and update the code to test the property finishRank
      //var instane = new NascarDataClient.DriverSummaryBySeason();
      //expect(instance).to.be();
    });
