...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NascarDataClient.DriverSummaryByTrack();
  });
  ...
  describe('DriverSummaryByTrack', function() {
    it('should create an instance of DriverSummaryByTrack', function() {
      // uncomment below and update the code to test DriverSummaryByTrack
      //var instane = new NascarDataClient.DriverSummaryByTrack();
      //expect(instance).to.be.a(NascarDataClient.DriverSummaryByTrack);
    });
