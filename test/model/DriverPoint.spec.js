...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NascarDataClient.DriverPoint();
  });
  ...
  describe('DriverPoint', function() {
    it('should create an instance of DriverPoint', function() {
      // uncomment below and update the code to test DriverPoint
      //var instane = new NascarDataClient.DriverPoint();
      //expect(instance).to.be.a(NascarDataClient.DriverPoint);
    });
    ...
    it('should have the property deltaPlayoff (base name: "delta_playoff")', function() {
      // uncomment below and update the code to test the property deltaPlayoff
      //var instane = new NascarDataClient.DriverPoint();
      //expect(instance).to.be();
    });

    it('should have the property projectedPlayoffPoints (base name: "projected_playoff_points")', function() {
      // uncomment below and update the code to test the property projectedPlayoffPoints
      //var instane = new NascarDataClient.DriverPoint();
      //expect(instance).to.be();
    });
    ...
    it('should have the property isClinch (base name: "is_clinch")', function() {
      // uncomment below and update the code to test the property isClinch
      //var instane = new NascarDataClient.DriverPoint();
      //expect(instance).to.be();
    });
