...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NascarDataClient.ManufacturerPoint();
  });
  ...
  describe('ManufacturerPoint', function() {
    it('should create an instance of ManufacturerPoint', function() {
      // uncomment below and update the code to test ManufacturerPoint
      //var instane = new NascarDataClient.ManufacturerPoint();
      //expect(instance).to.be.a(NascarDataClient.ManufacturerPoint);
    });
    ...
    it('should have the property bestFinish (base name: "best_finish")', function() {
      // uncomment below and update the code to test the property bestFinish
      //var instane = new NascarDataClient.ManufacturerPoint();
      //expect(instance).to.be();
    });
